                      ...
                      builder: (context, snapshot) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final formattedTime = DateFormat('hh:mm a').format(messageDate);
                            ...
                            if (index == messages.length - 1) {
                              ...
                              final nextMessageDate = messages[index + 1].timestamp!;
                              showDateHeader = messageDate.day != nextMessageDate.day ||
